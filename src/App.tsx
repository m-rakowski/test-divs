...
function App() {
  return (
    <div className="bg-red-500 grid grid-cols-[1fr_4fr] grid-rows-1 min-h-screen p-0 m-0 h-screen">
      <div className="bg-blue-500 overflow-scroll">
      ...
      <div className="bg-green-500 overflow-scroll">
        ...
        >
          ...
          >
            ⚠️ Click a radio below to see the bug! ⚠️
          </h2>
